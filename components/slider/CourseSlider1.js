          ...
          <div className="courses__item-two shine__animate-item">
            ...
            <div className="courses__item-two-content">
              <Link
                href="#"
                className="courses__item-tag"
                style={{ backgroundColor: "#F7EEFA", color: "#BC18E4" }}
              >
                Marketing
              </Link>
              <h5 className="title">
              ...
              <ul className="courses__item-meta list-wrap">
                <li>
                  <i className="flaticon-file" /> 08
                </li>
                <li>
                  <i className="flaticon-timer" /> 16h 30m
                </li>
                <li>
                  <i className="flaticon-user-1" /> 45
                </li>
              </ul>
              <div className="courses__item-bottom">
                <div className="course__price">
          ...
          <div className="courses__item-two shine__animate-item">
            ...
            <div className="courses__item-two-content">
              <Link
                href="#"
                className="courses__item-tag"
                style={{ backgroundColor: "#FFF0F9", color: "#FF109F" }}
              >
                Finance
              </Link>
              <h5 className="title">
                <Link href="/course-details">
                  Become a Certified JavaScript Web Developer
                </Link>
              </h5>
              <ul className="courses__item-meta list-wrap">
                <li>
                  <i className="flaticon-file" /> 12
                </li>
                <li>
                  <i className="flaticon-timer" /> 19h 30m
                </li>
                <li>
                  <i className="flaticon-user-1" /> 60
                </li>
              </ul>
              <div className="courses__item-bottom">
                <div className="course__price">
          ...
          <div className="courses__item-two shine__animate-item">
            ...
            <div className="courses__item-two-content">
              <Link
                href="#"
                className="courses__item-tag"
                style={{ backgroundColor: "#FFF3D3", color: "#F5B204" }}
              >
                Development
              </Link>
              <h5 className="title">
              ...
              <ul className="courses__item-meta list-wrap">
                ...
                <li>
                  <i className="flaticon-timer" /> 20h 00m
                </li>
                <li>
                  <i className="flaticon-user-1" /> 40
                </li>
              </ul>
              <div className="courses__item-bottom">
                <div className="course__price">
          ...
          <div className="courses__item-two shine__animate-item">
            ...
            <div className="courses__item-two-content">
              <Link
                href="#"
                className="courses__item-tag"
                style={{ backgroundColor: "#F5F0FF", color: "#560EF0" }}
              >
                Photography
              </Link>
              <h5 className="title">
              ...
              <ul className="courses__item-meta list-wrap">
                <li>
                  <i className="flaticon-file" /> 10
                </li>
                <li>
                  <i className="flaticon-timer" /> 20h 00m
                </li>
                <li>
                  <i className="flaticon-user-1" /> 30
                </li>
              </ul>
              <div className="courses__item-bottom">
                <div className="course__price">
          ...
          <div className="courses__item-two shine__animate-item">
            ...
            <div className="courses__item-two-content">
              <Link
                href="#"
                className="courses__item-tag"
                style={{ backgroundColor: "#DEF3FF", color: "#0496E9" }}
              >
                Technology
              </Link>
              <h5 className="title">
              ...
              <ul className="courses__item-meta list-wrap">
                <li>
                  <i className="flaticon-file" /> 16
                </li>
                <li>
                  <i className="flaticon-timer" /> 12h 00m
                </li>
                <li>
                  <i className="flaticon-user-1" /> 19
                </li>
              </ul>
              <div className="courses__item-bottom">
                <div className="course__price">
