      ...
      <section className="slider-area">
        <Slider {...settings} className="slider__active">
          <div
            ...
            data-background="/assets/img/banner/slider_bg01.jpg"
          >
              ...
              <div className="row">
                <div className="col-xl-6 col-lg-8">
                  <div className="slider__content">
                    ...
                    >
                      Any Time, Any Where To Do Discover Courses
                    </span>
                    <h2
          ...
          <div
            className="slider__item d-flex"
            data-background="/assets/img/banner/slider_bg02.jpg"
          >
            <div className="container">
              <div className="row">
                <div className="col-xl-6 col-lg-8">
          ...
          <div
            className="slider__item d-flex"
            data-background="/assets/img/banner/slider_bg03.jpg"
          >
            <div className="container">
              <div className="row">
                <div className="col-xl-6 col-lg-8">
