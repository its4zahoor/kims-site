        ...
        <div className="row align-items-end">
          ...
          <div className="col-lg-6">
            <div className="courses__nav-active">
              ...
              <button
                className={activeBtn("cat-one")}
                onClick={handleFilterKeyChange("cat-one")}
              >
                Design
              </button>
              <button
                className={activeBtn("cat-two")}
                onClick={handleFilterKeyChange("cat-two")}
              >
                Marketing
              </button>
              <button
                className={activeBtn("cat-three")}
            ...
            <div className="courses__item-two shine__animate-item">
              <div className="courses__item-two-thumb">
                ...
                <div className="course__price">
                  ...
                  >
                    <path
                      d="M17.5689 2.56089L0 34H99C101.761 34 104 31.7614 104 29V0H21.9336C20.1223 0 18.4525 0.979667 17.5689 2.56089Z"
                      fill="currentColor"
                    />
                  </svg>
              ...
              <div className="courses__item-two-content">
                ...
                <h5 className="title">
                  <Link href={`/course/${item.id}`}>{item.courseTitle}</Link>
                </h5>
