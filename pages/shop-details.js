            ...
            <div className="row">
              ...
              <div className="col-lg-6">
                <div className="shop-details-content">
                  <h2 className="title">SEO Tricks Tips</h2>
                  ...
                  <p>
                    ...
                    ametion consectetur Vesti at bulum nec odio aea the dumm
                    summ ipsum that dolocons rsus mal suada and fadolorit to the
                    consectetur elit.
                  </p>
                  <div className="shop-details-qty">
                    ...
                    <Link href="/shop-details" className="cart-btn btn">
                      Add To Cart
                    </Link>
                    <Link href="/shop-details" className="wishlist-btn">
                  ...
                  <div className="shop-details-bottom">
                    <ul className="list-wrap">
                      ...
                      <li className="sd-tag">
                        ...
                        <Link href="/shop-details">Education</Link>
                      </li>
                ...
                <div className="product-desc-wrap">
                  ...
                  <div className="tab-content" id="myTabContent2">
                    ...
                    >
                      <p>
                        Grursus mal suada faci lisis Lorem ipsum dolarorit more
                        ametion consectetur elit. Vesti at bulum nec odio aea
                        the dumm summ ipsum that dolocons rsus mal suada and
                        fadolorit to the consectetur elit. y to follow
                        tutorials, Exercises, and solutions. This course does
                        start from the beginning with very little knowledge and
                        gives a great overview of common tools used for data
                        science and progresses into more.
                      </p>
                    </div>
                    <div
                      className={
