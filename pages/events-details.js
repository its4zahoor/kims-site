            ...
            <div className="row justify-content-center">
              <div className="col-73">
                <div className="event-details-content">
                  <h2 className="title">
                    Global Education Fall Meeting for Every Students Who Are
                    Interested
                  </h2>
                  <div className="event-meta">
                    <ul className="list-wrap">
                      <li>
                        ...
                        DNCC Party Hall, United Kingdom
                      </li>
                      <li>
                  ...
                  <div className="event-details-img">
                    <img
                      src="/assets/img/events/event_details_img.jpg"
                      alt="img"
                    />
                  </div>
                  ...
                  <p className="info-one">
                    ...
                    the Internet tend to repeat that predefined chunks as
                    necessary, making this the first true dummy generator on the
                    Internet. It uses a dictionary of over 200 Latin words,
                    combined Lorem Ipsum looks reasonable.
                  </p>
                ...
                <aside className="event__sidebar">
                  ...
                  <div className="event-widget">
                    ...
                    <div className="sponsors-wrap">
                      <ul className="list-wrap">
                        <li>
                          <img src="/assets/img/brand/e_brand01.png" alt="" />
                        </li>
                        <li>
                          <img src="/assets/img/brand/e_brand02.png" alt="" />
                        </li>
                        <li>
                          <img src="/assets/img/brand/e_brand03.png" alt="" />
                        </li>
                      </ul>
                    </div>
                  </div>
