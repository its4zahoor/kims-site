                ...
                <div className="col-12">
                  <div className="instructor-details-wrap">
                    <div className="instructor-details-img">
                      <img
                        src="/assets/img/instructor/instructor_details_img.jpg"
                        alt="img"
                      />
                    </div>
                    <div className="instructor-details-content">
                      ...
                      <div className="bio-content">
                        ...
                        <p>
                          ...
                          consectetur elit. Vesti bulum a nec odio aea theawr
                          dumm ipsumm ipsum that dolocons rsus suada and
                          fadolorit consectetur elit. All the Lorem Ipsum
                          generators on their the Internet tend repeat
