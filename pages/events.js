                  ...
                  <div className="blog-widget">
                    ...
                    <div className="rc-post-item">
                      ...
                      <div className="rc-post-content">
                        <h4 className="title">
                          <Link href="/blog-details">
                            The Growing Management
                          </Link>
                        </h4>
                        <span className="date">
                          <i className="flaticon-calendar-date" /> 25 Dec, 2023
                        </span>
                      </div>
                    </div>
                    <div className="rc-post-item">
                      ...
                      <div className="rc-post-content">
                        <h4 className="title">
                          <Link href="/blog-details">
                            Make Your Magnificent
                          </Link>
                        </h4>
                        <span className="date">
                          <i className="flaticon-calendar-date" /> 26 Dec, 2023
                        </span>
                      </div>
                    </div>
                    <div className="rc-post-item">
                      ...
                      <div className="rc-post-content">
                        ...
                        <span className="date">
                          <i className="flaticon-calendar-date" /> 27 Dec, 2023
                        </span>
                      </div>
                    </div>
                    <div className="rc-post-item">
                  ...
                  <div className="col-xl-4 col-md-6">
                    <div className="events__item shine__animate-item">
                      <div className="events__item-thumb">
                        ...
                        >
                          <img
                            src="/assets/img/events/event_thumb04.jpg"
                            alt="img"
                          />
                        </Link>
                        <span className="events__date">
                  ...
                  <div className="col-xl-4 col-md-6">
                    <div className="events__item shine__animate-item">
                      <div className="events__item-thumb">
                        ...
                        >
                          <img
                            src="/assets/img/events/event_thumb05.jpg"
                            alt="img"
                          />
                        </Link>
                        <span className="events__date">
                  ...
                  <div className="col-xl-4 col-md-6">
                    <div className="events__item shine__animate-item">
                      <div className="events__item-thumb">
                        ...
                        >
                          <img
                            src="/assets/img/events/event_thumb06.jpg"
                            alt="img"
                          />
                        </Link>
                        <span className="events__date">
                  ...
                  <div className="col-xl-4 col-md-6">
                    <div className="events__item shine__animate-item">
                      <div className="events__item-thumb">
                        ...
                        >
                          <img
                            src="/assets/img/events/event_thumb07.jpg"
                            alt="img"
                          />
                        </Link>
                        <span className="events__date">
                  ...
                  <div className="col-xl-4 col-md-6">
                    <div className="events__item shine__animate-item">
                      <div className="events__item-thumb">
                        ...
                        >
                          <img
                            src="/assets/img/events/event_thumb08.jpg"
                            alt="img"
                          />
                        </Link>
                        <span className="events__date">
                  ...
                  <div className="col-xl-4 col-md-6">
                    <div className="events__item shine__animate-item">
                      <div className="events__item-thumb">
                        ...
                        >
                          <img
                            src="/assets/img/events/event_thumb09.jpg"
                            alt="img"
                          />
                        </Link>
                        <span className="events__date">
