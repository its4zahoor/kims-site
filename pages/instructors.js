  ...
  return (
    <>
      <Layout
        headerStyle={3}
        footerStyle={1}
        breadcrumbTitle="Top Class Instructors"
      >
        <div>
                    ...
                    <div className="instructor__img">
                      <div
                        ...
                        style={{
                          ...
                          borderRadius: "115px 135px 0 115px",
                        }}
                      />
                      <Link href="/instructor-details">
                        <img
                ...
                <div className="col-xl-3 col-lg-4 col-sm-6">
                  <div className="instructor__item">
                    <div className="instructor__img">
                      ...
                      <Link href="/instructor-details">
                        <img
                          src="/assets/img/instructor/instructor05.png"
                          alt="instructor"
                        />
                      </Link>
                    </div>
                ...
                <div className="col-xl-3 col-lg-4 col-sm-6">
                  <div className="instructor__item">
                    <div className="instructor__img">
                      ...
                      <Link href="/instructor-details">
                        <img
                          src="/assets/img/instructor/instructor06.png"
                          alt="instructor"
                        />
                      </Link>
                    </div>
                    <div className="instructor__content">
                      <div className="left">
                        <span className="designation">Web Development</span>
                        <h4 className="name">
                          <Link href="/instructor-details">Floyd Miles</Link>
                        </h4>
                      </div>
                      <div className="right">
                        <span className="share">
                  ...
                  <div className="instructor__item">
                    <div className="instructor__img">
                      <div
                        ...
                        style={{
                          ...
                          borderRadius: "135px 0 0 0px",
                        }}
                      />
                      <Link href="/instructor-details">
                        <img
                          src="/assets/img/instructor/instructor07.png"
                          alt="instructor"
                        />
                      </Link>
                    </div>
                    <div className="instructor__content">
                      <div className="left">
                        <span className="designation">Web Development</span>
                        <h4 className="name">
                          <Link href="/instructor-details">Eleanor Pena</Link>
                        </h4>
                      </div>
                      <div className="right">
                        <span className="share">
                  ...
                  <div className="instructor__item">
                    <div className="instructor__img">
                      <div
                        ...
                        style={{
                          ...
                          borderRadius: "135px 115px 115px 0px",
                        }}
                      />
                      <Link href="/instructor-details">
                        <img
                          src="/assets/img/instructor/instructor08.png"
                          alt="instructor"
                        />
                      </Link>
                    </div>
                    <div className="instructor__content">
                      <div className="left">
                        <span className="designation">Web Development</span>
                        <h4 className="name">
                          <Link href="/instructor-details">Jacob Jones</Link>
                        </h4>
                      </div>
                      <div className="right">
                        <span className="share">
                ...
                <div className="col-xl-3 col-lg-4 col-sm-6">
                  <div className="instructor__item">
                    <div className="instructor__img">
                      ...
                      <Link href="/instructor-details">
                        <img
                          src="/assets/img/instructor/instructor09.png"
                          alt="instructor"
                        />
                      </Link>
                    </div>
                    <div className="instructor__content">
                      <div className="left">
                        <span className="designation">Graphic Design</span>
                        <h4 className="name">
                          <Link href="/instructor-details">Robert Fox</Link>
                        </h4>
                      </div>
                      <div className="right">
                        <span className="share">
                  ...
                  <div className="instructor__item">
                    ...
                    <div className="instructor__content">
                      <div className="left">
                        <span className="designation">Web Design</span>
                        <h4 className="name">
                          <Link href="/instructor-details">Wade Warren</Link>
                        </h4>
                      </div>
                      <div className="right">
                        <span className="share">
                  ...
                  <div className="instructor__item">
                    ...
                    <div className="instructor__content">
                      <div className="left">
                        <span className="designation">Digital Marketing</span>
                        <h4 className="name">
                          <Link href="/instructor-details">Guy Hawkins</Link>
                        </h4>
                      </div>
                      <div className="right">
                        <span className="share">
                  ...
                  <div className="instructor__item">
                    ...
                    <div className="instructor__content">
                      <div className="left">
                        <span className="designation">Web Development</span>
                        <h4 className="name">
                          <Link href="/instructor-details">Bessie Cooper</Link>
                        </h4>
                      </div>
                      <div className="right">
                        <span className="share">
                ...
                <div className="col-lg-6 col-md-10 col-sm-11">
                  ...
                  >
                    <div className="quick__action-content">
                      <h4 className="title">
                        Best Instructors from around <br /> the world
                      </h4>
